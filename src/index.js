...
L.marker([60.60678124412115, 15.62869672216047], {
  ...
  .addTo(mymap)
  .bindPopup(
    "<h3>Telia Shop Falun</h3><img src='src/img/telia.jpeg'width='150px'><p style='font-size: 12px;'>I work here once a week. It's close to the museum (se line). The polyfill is the building of Falan Galleria.</p>",
  );
...
var IkeaLayer = L.imageOverlay('src/img/ikea.png', [
  [60.482731, 15.419809],
  [60.480601, 15.422171],
]);
